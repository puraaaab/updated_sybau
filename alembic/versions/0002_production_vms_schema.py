...
def upgrade() -> None:
    ...
    if 'person_journey_events' not in tables:
        op.create_table(
    ...
    if 'vehicle_journey_events' not in tables:
        op.create_table(
    ...
    if 'camera_topologies' not in tables:
        op.create_table(
            'camera_topologies',
            sa.Column('id', sa.Integer(), primary_key=True, index=True),
    ...
    if 'camera_baselines' not in tables:
        op.create_table(
            'camera_baselines',
            sa.Column('id', sa.Integer(), primary_key=True, index=True),
            sa.Column('camera_id', sa.String(), index=True, nullable=False),
    ...
    if 'evidence_chain_of_custody' not in tables:
        op.create_table(
    ...
    if 'ai_skills_registry' not in tables:
        op.create_table(
            'ai_skills_registry',
            sa.Column('id', sa.Integer(), primary_key=True, index=True),
    ...
    if 'camera_skill_assignments' not in tables:
        op.create_table(
